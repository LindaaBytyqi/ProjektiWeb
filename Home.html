...
<body>
    <nav>
        ...
        <div class="main-text">
            ...
            <a href = "product.html"> <button class="button">OrderNow</button></a>
        </div>
    </section>
    </div>
    <section id = "about">
        ...
        <!--<h1>Start Your Journey With Us</h1>-->
        <div class = "video">
            <!--<img src = "pexPix.jpg" width="600" height="340">-->
            <video src = "flwVid.mp4" loop autoplay muted width="100%" height="auto"></video>
        </div>
        <div class ="text-container">
            ...
            With our skilled <br>florists and personalize their bouquets.<br>Choose us to bring the warmth and beauty of flowers to 
            <br> every occasion of your life.<br></p>
            <!--<a href = "products.html"> <button class = "button">Order Now</button></a>-->
        </div>
        </div>
        </section>
